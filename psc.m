...
%     '/brashear/yaron/msqc', 'CaptureDiary',true)
myjob=batch(@windowpsc,0,{},'Matlabpool',15,'CurrentDirectory', ...
    '/brashear/yaron/brownian', 'CaptureDiary',true)
...
% myjob=batch(@context2psc,0,{},'Matlabpool',15,'CurrentDirectory', ...
%     '/brashear/yaron/msqc', 'CaptureDiary',true)
myjob=batch(@window1psc,0,{},'Matlabpool',15,'CurrentDirectory', ...
    '/brashear/yaron/brownian', 'CaptureDiary',true)
